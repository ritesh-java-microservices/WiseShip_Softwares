...
public class WiseShipGeneralUniversalEntity extends WiseShipBasicCommonEntity {

    private WiseShipStringEntity stringEntity;

    private WiseShipDateEntity dateEntity;

    private WiseShipDoubleEntity doubleEntity;

    private WiseShipLongEntity longEntity;

    private WiseShipObjectEntity objectEntity;
    ...
    public void initializeStringEntity(String dataString,
        ...
        stringEntity = new WiseShipStringEntity();
    ...
    public void initializeDateEntity(Date dataDate,
        ...
        dateEntity = new WiseShipDateEntity();
    ...
    public void initializeObjectEntity(Object dataObject,
        ...
        objectEntity = new WiseShipObjectEntity();
    ...
    public void initializeDoubleEntity(Double dataDouble,
        ...
        doubleEntity = new WiseShipDoubleEntity();
    ...
    public void initializeLongEntity(Long dataLong,
        ...
        longEntity = new WiseShipLongEntity();
