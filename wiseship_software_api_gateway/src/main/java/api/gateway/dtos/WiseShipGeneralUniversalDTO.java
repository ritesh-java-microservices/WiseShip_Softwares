...
public class WiseShipGeneralUniversalDTO extends WiseShipBasicCommonDTO {

    private WiseShipStringDTO stringDTO;

    private WiseShipDateDTO dateDTO;

    private WiseShipDoubleDTO doubleDTO;

    private WiseShipLongDTO longDTO;

    private WiseShipObjectDTO objectDTO;
    ...
    public void initializeStringDTO(String dataString,
        ...
        stringDTO = new WiseShipStringDTO();
    ...
    public void initializeObjectDTO(Object dataObject,
        ...
        objectDTO = new WiseShipObjectDTO();
    ...
    public void initializeDoubleDTO(Double dataDouble,
        ...
        doubleDTO = new WiseShipDoubleDTO();
